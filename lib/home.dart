...
const List<String> course = <String>['','ITIS428','ITIS468','ITIS452','ITIS414'];
const List<String> section = <String>['','1','2',];
...
class _HomeState extends State<Home> {
      ...
      body:SingleChildScrollView(
        child: Column(
          ...
          //////////////////////////// Chart
            ...
            ////////////////////////////////////////////////// Footer
            Footer(child: Container( width: 1550, height: 370, color: Colors.grey[400],
              child: 
              Column(
                children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.fromLTRB(500, 1, 1, 1),
                      child: Row(children: [
                        Icon(Icons.villa,size: 40,),
                        UOB(),
                      ],),
                    ), SizedBox(height: 50,),
                    Row(children: [
                        Container( width: 1420, height: 100, color: Colors.grey[500],
                          child: Row(children: [
                          TextButton(onPressed: (){}, child: Container(child: Image(image: AssetImage('images/instagram1.png'),width: 50,height: 50,),)),
                          TextButton(onPressed: (){}, child: Container(child: Image(image: AssetImage('images/twitter.png'),width: 50,height: 50,),)),
                          TextButton(onPressed: (){}, child: Container(child: Image(image: AssetImage('images/facebook.png'),width: 50,height: 50,),)),
                          TextButton(onPressed: (){}, child: Container(child: Image(image: AssetImage('images/youtube.png'),width: 50,height: 50,),)),
                          ],),)
                      ],),
                ]
                ,)
  ...
  List<GDPData> getChartData(){
    ...
    Widget blackBoardUrl(){
      ...
      return ElevatedButton(onPressed: (){launchUrl(url);},
       child: Text("data")
      );
    }
    //////////////// Sis url
